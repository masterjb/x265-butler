...
- **`:X.Y.Z`** — Exact-semver pin (e.g. `ghcr.io/masterjb/x265-butler:2.38.1`). Reproducible, frozen at the build that created it. Recommended for production-stability operators.
...
> - CA template: Edit Container → set `Repository` to `ghcr.io/masterjb/x265-butler:2.38.1`
> - `docker-compose.yml`: `image: ghcr.io/masterjb/x265-butler:2.38.1`
