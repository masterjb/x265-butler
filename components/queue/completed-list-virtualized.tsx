...
// design-system/pages/queue.md §10.3: card-list render (no md-table branch).
// NOTE (27-03): the completed pane now occupies ~50% of the md+ row (grid
// minmax(0,1fr) — equal split with pending); the former 360px width cap that
// originally precluded a table no longer holds, so a table render is a viable
// future enhancement — the card-list is retained here deliberately (out of
// 27-03 scope). Virtualizer engages when count > 50.
