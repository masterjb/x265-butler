        ...
        <TooltipContent className="max-w-xs flex-col items-start gap-2 p-3 text-left">
          <div className="flex flex-col gap-1">
            ...
            <ul className="flex flex-col gap-0.5 text-xs">
              ...
              {/* 49-05 AC-15: ONE added line. The 0..51 axis stays uniform across
                  all four encoders (20-03 T0 decision + the zod schema in
                  quality-step.tsx), so the honest fix is to say what that
                  uniformity does NOT mean — not to rebuild the axis per encoder. */}
              <li>{t('step5.crfExplainer.notTransferable')}</li>
            </ul>
          </div>
          <div
            role="img"
