...
export function LibraryCardList({
  ...
  rows: FileRow[];
  // 50-04: see LibraryTable — optional with an empty default; a missing map
  // means "no removable entry known".
    ...
    <>
      ...
      <ul className="flex flex-col gap-2">
        {rows.map((row) => {
          ...
          // 50-04: keyed off row.status (server truth), not the optimistic override.
              ...
              <div className="flex gap-3 rounded-lg border border-border bg-card p-3 transition-all duration-150 hover:bg-muted/50">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-2 flex justify-end gap-2">
                    ...
                    {/* 50-04: inverse of AddToBlocklistAction, same slot. */}
