...
export function StatusChip({
  ...
  label: string;
  className?: string;
  // 50-04: optional supplementary explanation, currently used only for
  // `blocklisted` rows that carry NO removable single entry. Omitted → the
  // rendered markup is byte-identical to pre-50-04 (no empty title attribute).
  // The chip stays NON-interactive on purpose (Z.103): the absence of the
  // action button is the primary signal, this is only the reason.
  title?: string;
}) {
