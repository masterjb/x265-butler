...
//
// 50-06: MOVED here from `ffmpeg.ts` (pulled, not copied — AC-17) so the second
...
//
// ⚠ INVARIANT (49-02, unchanged by the move): `profiles.ts` must NEVER import this
...
// Pass-1 argv and break the apples-to-apples VMAF invariant (11-03 SR3 / 35-01 AC-6
// / 43-01 AC-8). The move does not relax that rule — it only gives the two
