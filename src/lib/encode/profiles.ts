...
export const PROFILE_BUILDERS: Record<EncoderId, ProfileBuilder> = {
  ...
  // `-look_ahead 1 -look_ahead_depth 40` enables MB-tree-style lookahead.
  // 12-03: preset positional arg replaces hardcoded 'slow'; non-preset flags
  // (-global_quality, -look_ahead, -look_ahead_depth) BYTE-IDENTICAL (audit SR1).
  qsv: (crf, preset) => [
    '-c:v',
    'hevc_qsv',
    '-preset',
