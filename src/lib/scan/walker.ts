...
// 50-03 (E5): `normalizeExtensions` moved to the media-eligibility leaf so the
// walker and the watch path cannot drift apart on what "extension" means. The
// body there is byte-identical to the one that lived here until 829101f.
import { normalizeExtensions } from './media-eligibility';
