...
// pattern: memoized, logged ONCE at info (NEVER debug — debug is dropped at the
// `LOG_LEVEL ?? 'info'` instance gate BEFORE the multistream fan-out, the
// 22-01 → 38-02 dark-surface trap), restart required.
//
