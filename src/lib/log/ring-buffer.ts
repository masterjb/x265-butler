...
/**
 * 24-05 F7: operator-facing clear. Empties the ring (lines + totalBytes).
 * Unlike `_resetForTesting`, this is prod-callable (NO NODE_ENV gate) — it
 * backs the DELETE /api/logs "Clear log" action. Leaves MAX_LINES/MAX_BYTES
 * untouched; pushLine continues to work afterward.
 */
