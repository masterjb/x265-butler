...
// 48-01: empty scanIntegrity block for fixture-using tests pre-48-01 (no scan
// has completed in the process yet).
...
// 46-02 (D2): empty nvidiaGpu block for fixture-using tests pre-46-02 (the
// common no-toolkit host — nvidia-smi absent → binary_missing).
