...
// Local reproduction of the throttle helper from BenchOrchestrator._makeComboProgressEmitter
// (src/lib/bench/orchestrator.ts). Test contract — if the orchestrator implementation
// changes, this test must be updated to match (intentional duplication keeps the test
// self-contained; it does NOT import the orchestrator).
const PHASE_ANCHORS = {
