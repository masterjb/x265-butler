...
const {
  ...
  // 40-01 (audit S2): mock the sampler so server-init tests assert the
...
// 40-01 (audit S2): stub the cpu_attribution sampler — its start/stop are wired
...
describe('server-init', () => {
  ...
  // 40-01 (audit S2): cpu_attribution sampler start/stop wiring.
