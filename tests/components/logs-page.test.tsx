...
describe('LogsClient — Per-Job pagination (32-04)', () => {
  ...
  it('changing size to 100 calls replace with size=100 and drops page', async () => {
    ...
    // base-ui Select mounts its listbox in a portal asynchronously — under CI
    // load the option can lag the trigger click, so poll with findByRole
    // instead of the synchronous getByRole (CI flake, v2.31.0 tag pipeline).
