...
describe('DiagnosticsClient 23-02 Render Devices card', () => {
  ...
  it('AC-5: populated → both rows render; out-of-group row is amber with AlertTriangle, in-group muted', () => {
    ...
    // out-of-group → amber + icon + text (never color alone)
    ...
    expect(amber!.textContent).toMatch(/not in group|nicht in Gruppe/i);
