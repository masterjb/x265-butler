    ...
    return jsonResponse(
      {
        ...
        // 49-05 AC-5: the Settings form rebuilds its EncoderDetectionState from
        // THIS body. Without the tier the QSV CRF helper would fall back to its
        // "tier not verified" wording after every encoder-tab save, even though
        // the refresh just re-probed it.
