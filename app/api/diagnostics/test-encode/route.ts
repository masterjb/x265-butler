...
export async function POST(request: Request): Promise<Response> {
  ...
  try {
    // 45-01: no pre-resolved binary — runTestEncode's internal selector picks by the
    ...
    logger.info(
      {
        ...
        // 50-06 (AC-28): the requested encoder rides on the EXISTING line — no
        // second log call (39-01 discipline). Without it a post-incident reader
