...
export type EncoderDetectionState = {
  ...
  vaapiDevice?: string;
  // 49-05: the boot-resolved QSV ratecontrol tier (30-01). undefined = both probe
  ...
  // still emits instead of going silent (AC-3b).
...
export function SettingsClient({
  ...
  // 34-02: live render-node probe list for the Encoder-tab GPU-Device picker.
  ...
  useEffect(() => {
    ...
    // 35-02 (audit MH-1): the onboarding Auto-Crop callout deep-links #auto-crop,
    ...
    // the non-returning #paths branch per the SR4 ordering invariant above.
      ...
      <Tabs value={tab} onValueChange={onTabChange}>
        ...
        <TabsContent value="paths" className="mt-6">
          ...
          <div className="flex flex-col gap-4">
            ...
            {/* 24-03 (F2): Cache card mounts BELOW the shares list. Self-contained
